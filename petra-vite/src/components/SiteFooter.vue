...
const columnas = [
  ...
  },
  {
    titulo: 'Contacto',
    links: [
      { texto: 'hola@petraviajes.com.ar', href: 'mailto:hola@petraviajes.com.ar' },
      { texto: '+54 11 0000-0000', href: 'tel:+541100000000' },
      { texto: 'Av. Ejemplo 1234, CABA', href: '#' },
    ],
  },
  {
    titulo: 'Seguinos',
...
footer ul a{font-size:14px; color:#aeb2ce; transition:color .2s ease;}
